...
/* Ethernet driver */
#if defined(CONFIG_ZINC_GEM)
# define CONFIG_SYS_FAULT_ECHO_LINK_DOWN
# define CONFIG_BOOTP_MAY_FAIL
#endif

/* QSPI */
#ifdef CONFIG_ZINC_QSPI
...
#ifdef CONFIG_NAND_ZINC
#define CONFIG_SYS_MAX_NAND_DEVICE	1
#define CONFIG_SYS_NAND_ONFI_DETECTION
#endif

#ifdef CONFIG_USB_EHCI_ZINC
...
# if defined(CONFIG_MMC_SDHCI_ZINC)
...
/* I2C */
#if defined(CONFIG_SYS_I2C_ZINC)
# define CONFIG_SYS_I2C
#endif

/* EEPROM */
#ifdef CONFIG_ZINC_EEPROM
